...
namespace Samr.ERP.WebApi.Services
{
    /// <summary>
    /// Renders email content based on razor templates
    /// </summary>
    public interface IHtmlTemplateXService
    {
        /// <summary>
    ...
    public class HtmlTemplateXService : IHtmlTemplateXService
    {
        private IRazorViewEngine _viewEngine;
        private readonly IServiceProvider _serviceProvider;
        private readonly ITempDataProvider _tempDataProvider;

        public HtmlTemplateXService(IRazorViewEngine viewEngine, IServiceProvider serviceProvider, ITempDataProvider tempDataProvider)
        {
